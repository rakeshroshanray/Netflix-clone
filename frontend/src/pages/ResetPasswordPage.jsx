        ...
        <div className="h-screen w-full flex items-center justify-center">
            <div className="w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="password" className="text-sm font-medium text-gray-300 block">New Password</label>
                        <input 
                            type="password" 
                    ...
                    <button className="w-full py-2 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700">Reset Password</button>
                </form>
            </div>
        </div>
    );
